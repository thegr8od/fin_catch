        ...
        <div className="w-[95%] md:w-[85%] lg:w-[80%] h-full z-10 relative">
            ...
            <div className="w-10/12 mx-auto bg-[#FAD0C4] p-4 flex flex-col">
                ...
                <form onSubmit={isTimeUp ? goToObjectiveQuestion : handleSendMessage} className="flex items-center gap-2 mt-2 z-10 relative">
                    ...
                    <button 
                      type="button"
                      onClick={goToObjectiveQuestion}
                      className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded flex items-center cursor-pointer animate-pulse z-20 relative"
                    >
                      다음 문제
                    </button>
                    ) : (
                        <button 
                            type="submit"
                            className="bg-yellow-200 hover:bg-yellow-300 px-6 py-3 rounded flex items-center cursor-pointer z-20 relative"
                        >
                            전송
            ...
            <div className="w-10/12 mx-auto bg-white p-5 rounded-lg shadow-lg min-h-32 mt-4 border-2 border-blue-400">
                ...
                <div className="flex flex-wrap justify-between mt-3">
                    <button 
                        ...
                        className={`px-4 py-2 text-lg transition-all cursor-pointer ${
                            selectedOption === 0 
                                ? 'text-red-600 font-bold underline scale-110' 
                        ...
                        {cats.map(cat => (
                            <div key={cat.id} 
                                className={`flex items-center p-3 rounded-lg transition-all ${
                                    cat.id === (winner?.id || 0) 
                                        ? 'bg-yellow-100 border-2 border-yellow-400 shadow-md transform scale-105' 
