...
const SplashPage = () => {
  return (
    <Background backgroundImage={mainBg}>
      {/* 콘텐츠 컨테이너 */}
      <div className="w-full h-full flex flex-col items-center justify-center gap-40 relative z-10 py-20">
        <h1 className="text-4xl md:text-5xl text-white font-bold tracking-wider text-shadow-lg animate-glitch">Fin Catch</h1>
