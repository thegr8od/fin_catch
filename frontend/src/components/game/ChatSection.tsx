...
const ChatSection = React.memo(
  ({ chatMessages = [], chatInput = "", onChatInputChange, setChatInput, onChatSubmit, handleSubmit, showInput = true, showMessages = true, isAnswerBlocked }: ChatSectionProps) => {
          ...
          <div className="w-full mt-auto" id="chatbox-input">
            <form onSubmit={handleSubmit || onChatSubmit} className="flex h-8">
              <input
                ...
                placeholder={isBlocked ? "객관식 오답으로 2초동안 채팅이 제한됩니다..." : "메시지를 입력하세요..."}
                disabled={isBlocked}
              />
